...
\draw[color=black] plot[smooth] function{(x - 3)**2 + 3}; 
\draw (3.5,3.2) node[right] {$\scriptscriptstyle f_2$}; 
\draw[color=black] plot[smooth] function{(x + 2)**2 + 1}; 
\draw (-1.5,1.2) node[right] {$\scriptscriptstyle f_3$}; 
\end{scope} 
...
$f_1$ & $S(-1|2)$ & $x=-1$ & Keine Nullstelle\\ \hline 
$f_2$ & $S(3|3)$ & $x=3$ & Keine Nullstelle\\ \hline 
$f_3$ & $S(-2|1)$ & $x=-2$ & Keine Nullstelle\\ 
...
\vspace{1em} 
$\cancel{f_1(x)=\left(x + 2\right)^{2} - 1}$\\[1em] 
...
\item 
$f_5(x)=\left(x + 2\right)^{2} - 2$
\item 
$f_6(x)=\left(x + 2\right)^{2} + 1$
\end{enumerate} 
\end{multicols} 
\definecolor{cqcqcq}{rgb}{0.75,0.75,0.75} 
\begin{tikzpicture}[domain=-3:3,scale=1][line cap=round,line join=round,>=triangle 45,x=1.0cm,y=1.0cm]\draw[color=cqcqcq,dash pattern=on 2pt off 2pt, xstep=1.0cm,ystep=1.0cm] (-3.0,-3.0) grid (3.0,3.0); 
...
\draw[color=black] plot[smooth] function{(x + 1)**2 + 2}; 
\draw (-0.5,2.2) node[right] {$\scriptscriptstyle f_2$}; 
\draw[color=black] plot[smooth] function{(x + 2)**2}; 
\draw (-1.5,0.2) node[right] {$\scriptscriptstyle f_3$}; 
\draw[color=black] plot[smooth] function{(x + 1)**2 + 2}; 
\draw (-0.5,2.2) node[right] {$\scriptscriptstyle f_4$}; 
\draw[color=black] plot[smooth] function{(x + 2)**2 - 2}; 
\draw (-1.5,-1.8) node[right] {$\scriptscriptstyle f_5$}; 
\draw[color=black] plot[smooth] function{(x + 2)**2 + 1}; 
\draw (-1.5,1.2) node[right] {$\scriptscriptstyle f_6$}; 
\end{scope} 
\end{tikzpicture}\end{aufgabe} 
\begin{aufgabe} ~ \\ 
