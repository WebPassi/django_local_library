...
\draw (0.5,-2.8) node[right] {$\scriptscriptstyle f$}; 
\end{scope} 
...
\begin{scope} 
\clip (-3,-3) rectangle (3,3); 
\draw[color=black] plot[smooth] function{(x - 3)**2 - 1}; 
\draw (3.5,-0.8) node[right] {$\scriptscriptstyle f_1$}; 
\draw[color=black] plot[smooth] function{(x - 1)**2 - 1}; 
\draw (1.5,-0.8) node[right] {$\scriptscriptstyle f_2$}; 
...
$f_1$ & $S(3|-1)$ & $x=3$ & $x_1=2\quad x_2=4$\\ \hline 
$f_2$ & $S(1|-1)$ & $x=1$ & $x_1=0\quad x_2=2$\\ \hline 
$f_3$ & $S(2|-2)$ & $x=2$ & $x_1\approx 0,\hspace{-1pt}59\quad x_2\approx3,\hspace{-1pt}41$\\ 
...
\vspace{1em} 
$\cancel{f_1(x)=x^{2} - 2}$\\[1em] 
$\cancel{f_2(x)=\left(x - 2\right)^{2} - 2}$\\[1em] 
$f_3(x)=\left(x - 2\right)^{2} - 2$\\[1em] 
$\cancel{f_4(x)=x^{2}}$\\[1em] 
\end{minipage} 
...
\begin{enumerate}[a)] 
\item 
$f_1(x)=\left(x + 2\right)^{2} + 1$
\item 
$f_2(x)=\left(x - 1\right)^{2} - 2$
\item 
$f_3(x)=x^{2}$
\item 
$f_4(x)=x^{2} - 2$
\item 
$f_5(x)=\left(x + 1\right)^{2} + 1$
\item 
$f_6(x)=\left(x + 2\right)^{2}$
\end{enumerate} 
\end{multicols} 
\definecolor{cqcqcq}{rgb}{0.75,0.75,0.75} 
\begin{tikzpicture}[domain=-3:3,scale=1][line cap=round,line join=round,>=triangle 45,x=1.0cm,y=1.0cm]\draw[color=cqcqcq,dash pattern=on 2pt off 2pt, xstep=1.0cm,ystep=1.0cm] (-3.0,-3.0) grid (3.0,3.0); 
...
\draw (0.5,0.2) node[right] {$\scriptscriptstyle f_3$}; 
\draw[color=black] plot[smooth] function{x**2 - 2}; 
\draw (0.5,-1.8) node[right] {$\scriptscriptstyle f_4$}; 
\draw[color=black] plot[smooth] function{(x + 1)**2 + 1}; 
\draw (-0.5,1.2) node[right] {$\scriptscriptstyle f_5$}; 
\draw[color=black] plot[smooth] function{(x + 2)**2}; 
\draw (-1.5,0.2) node[right] {$\scriptscriptstyle f_6$}; 
\end{scope} 
\end{tikzpicture}\end{aufgabe} 
\begin{aufgabe} ~ \\ 
