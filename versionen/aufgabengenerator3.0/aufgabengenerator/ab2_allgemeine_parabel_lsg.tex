...
\draw (2.5,0.2) node[right] {$\scriptscriptstyle f_2$}; 
...
$f_1$ & $S(-2|-1)$ & $x=-2$ & $x_1=-3\quad x_2=-1$ & oben & normal\\ \hline 
$f_2$ & $S(2|0)$ & $x=2$ & $x=2$ & oben & gestaucht\\ \hline 
$f_3$ & $S(0|2)$ & $x=0$ & Keine Nullstelle & oben & gestreckt\\ 
...
\vspace{1em} 
$\cancel{f_1(x)=\left(x + 2\right)^{2} + 2}$\\[1em] 
$\cancel{f_2(x)=- \frac{1}{3} \left(x - 1\right)^{2} - 2}$\\[1em] 
$f_3(x)=- 4 \left(x - 2\right)^{2} - 1$\\[1em] 
$\cancel{f_4(x)=- 4 \left(x - 2\right)^{2} + 2}$\\[1em] 
\end{minipage} 
...
\item 
$f_2(x)=3 \left(x - 1\right)^{2} + 2$ \\ 
$f_2(x)=3 x^{2} - 6 x + 5$ \\ 

\item 
$f_3(x)=- 2 \left(x + 2\right)^{2} - 2$ \\ 
$f_3(x)=- 2 x^{2} - 8 x - 10$ \\ 

\item 
$f_4(x)=2 \left(x + 2\right)^{2} + 2$ \\ 
$f_4(x)=2 x^{2} + 8 x + 10$ \\ 
...
\item 
$f_2(x)=2 x^{2} - 4 x + 3$ \\ 
$f_2(x)=2 \left(x - 1\right)^{2} + 1$ \\ 

\item 
$f_3(x)=- 3 x^{2} - 12 x - 10$ \\ 
$f_3(x)=- 3 \left(x + 2\right)^{2} + 2$ \\ 

\item 
$f_4(x)=x^{2} + 2 x - 2$ \\ 
$f_4(x)=\left(x + 1\right)^{2} - 3$ \\ 

\item 
$f_5(x)=x^{2} - 4 x + 7$ \\ 
$f_5(x)=\left(x - 2\right)^{2} + 3$ \\ 

\item 
$f_6(x)=- 3 x^{2} + 18 x - 27$ \\ 
$f_6(x)=- 3 \left(x - 3\right)^{2}$ \\ 
