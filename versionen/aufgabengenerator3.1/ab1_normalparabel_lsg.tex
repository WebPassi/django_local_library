...
\draw[color=black] plot[smooth] function{(x - 3)**2 - 2}; 
\draw (3.5,-1.8) node[right] {$\scriptscriptstyle f_2$}; 
...
$f_1$ & $S(-2|0)$ & $x=-2$ & $x=-2$\\ \hline 
$f_2$ & $S(3|-2)$ & $x=3$ & $x_1\approx 1,\hspace{-1pt}59\quad x_2\approx4,\hspace{-1pt}41$\\ \hline 
$f_3$ & $S(1|2)$ & $x=1$ & Keine Nullstelle\\ 
...
\vspace{1em} 
$\cancel{f_1(x)=x^{2}}$\\[1em] 
$\cancel{f_2(x)=\left(x - 2\right)^{2} + 1}$\\[1em] 
$\cancel{f_3(x)=\left(x + 1\right)^{2} - 2}$\\[1em] 
$f_4(x)=\left(x - 1\right)^{2} + 1$\\[1em] 
\end{minipage} 
...
\draw[color=black] plot[smooth] function{(x + 1)**2 + 1}; 
\draw (-0.5,1.2) node[right] {$\scriptscriptstyle f_4$}; 
\draw[color=black] plot[smooth] function{(x + 2)**2 + 1}; 
\draw (-1.5,1.2) node[right] {$\scriptscriptstyle f_5$}; 
\draw[color=black] plot[smooth] function{(x - 2)**2 - 1}; 
\draw (2.5,-0.8) node[right] {$\scriptscriptstyle f_6$}; 
\end{scope} 
\end{tikzpicture}\end{aufgabe} 
\begin{aufgabe} ~ \\ 
...
\begin{enumerate}[a)] 
\item 
$f_1(x)=\left(x + 2\right)^{2}$
\item 
$f_2(x)=\left(x - 3\right)^{2} - 2$
\item 
