...
\begin{scope} 
\clip (-3,-3) rectangle (3,3); 
\draw[color=black] plot[smooth] function{-2*(x - 2)**2 + 2}; 
\draw (-3,-3) -- (3,3); 
\end{scope} 
...
\begin{scope} 
\clip (-3,-3) rectangle (3,3); 
\draw[color=black] plot[smooth] function{4*x**2/3 - 1}; 
\end{scope} 
\end{tikzpicture}\end{minipage} 
\begin{minipage}{0.1\textwidth} 
 ~ \end{minipage} 
...
\vspace{1em} 
$\cancel{f_1(x)=2 x^{2} - 1}$\\[1em] 
$\cancel{f_2(x)=- 4 \left(x + 2\right)^{2} + 1}$\\[1em] 
$\cancel{f_3(x)=- \left(x + 1\right)^{2} - 2}$\\[1em] 
$f_4(x)=\frac{4 x^{2}}{3} - 1$\\[1em] 
\end{minipage} 
