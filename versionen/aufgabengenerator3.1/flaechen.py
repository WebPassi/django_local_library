...
# Faktor
    ...
    if a==0:
        a=-5
# Funktion
    funcfactor=a*(x-n1)*(x-n2)
    func=expand(funcfactor)
    limit='(x,n1,n2)'
    lsg=integrate(func,eval(limit))
    fp.write("$$f(x)=" + latex(func) + "$$ \n")
    ft.write("$$f(x)=" + latex(func) + "$$ \n")
    ft.write("{\\bf Nullstellen bestimmen:} \\\\ \n")
    ft.write("\\begin{align*} \n")
    ft.write("f(x)&=0 \\\\ \n")
    ft.write(latex(func) + "&=0 \\text{\\quad ($pq$-Formel)} \\\\ \n")
    ft.write("x_1&=" + latex(n1) + "\\\\ \n")
    ft.write("x_2&=" + latex(n2) + "\\\\ \n")
    ft.write("\\end{align*}")
    ft.write('{\\bf Von Nullstelle zu Nullstelle integrieren und Betr\\"age setzen:}')
    ft.write("$$A=\\left|" + latex(Integral(func,eval(limit))) + "\\right| = \\left|" + latex(lsg) + "\\right|=" + latex(abs(lsg)) + "$$")
...
# Funktion
    ...
    func=expand(funcfactor)
    funcquad=expand((x-n1)*(x-n3))
    funcfactorx=a*x*funcquad
    limit1='(x,n1,n2)'
    limit2='(x,n2,n3)'
    lsg1=integrate(func,eval(limit1))
    lsg2=integrate(func,eval(limit2))
    fp.write("$$f(x)=" + latex(func) + "$$ \n")
    ft.write("$$f(x)=" + latex(func) + "$$ \n")
    ft.write("{\\bf Nullstellen bestimmen:} \\\\ \n")
    ft.write("\\begin{align*} \n")
    ...
    ft.write(latex(funcfactorx) + "&=0 \\\\ \n")
    ft.write("x_1&=0 \\\\ \n")
    ft.write(latex(funcquad) + "&=0 \\text{\\quad ($pq$-Formel)} \\\\ \n")
    ft.write("x_2&=" + latex(n1) + "\\\\ \n")
    ft.write("x_3&=" + latex(n3) + "\\\\ \n")
    ft.write("\\end{align*}")
    ft.write('{\\bf Von Nullstelle zu Nullstelle integrieren und Betr\\"age setzen:}')
    ft.write("$$A=\\left|" + latex(Integral(func,eval(limit1))) + "\\right| +" + "\\left|" + latex(Integral(func,eval(limit2))) + "\\right|=\\left|" + latex(lsg1) + "\\right|+\\left|" + latex(lsg2) + "\\right|=" + latex(abs(lsg1)) + "+" + latex(abs(lsg2)) + "=" + latex(abs(lsg1)+abs(lsg2)) + "$$ \n")
    ft.write("\\clearpage")
...
for menge in range(4):
### Aufgabe 1: 
    fp.write('\\begin{aufgabe}[Quadratische Funkion] ~ \\\\ \n')
    fp.write('Bestimmen Sie die Fl\\"ache zwischen dem Graph von $f$ und der $x$-Achse.')
    ft.write('\\begin{aufgabe}[Quadratische Funkion] ~ \\\\ \n')
    ft.write('Bestimmen Sie die Fl\\"ache zwischen dem Graph von $f$ und der $x$-Achse.')
    ##### Which exercise
    quadflaeche() 
    #####
    fp.write('\n')
    ...
    ft.write('\\vspace{1em}')
    ### Aufgabe 2: 
    fp.write('\\begin{aufgabe}[Kubische Funktion] ~ \\\\ \n')
    fp.write('Bestimmen Sie die Fl\\"ache zwischen dem Graph von $f$ und der $x$-Achse.')
    ft.write('\\begin{aufgabe}[Kubische Funktion] ~ \\\\ \n')
    ft.write('Bestimmen Sie die Fl\\"ache zwischen dem Graph von $f$ und der $x$-Achse.')
    ##### Which exercise
    kubischflaeche() 
    #####
