...
$f_1$ & $S(-1|-2)$ & $x=-1$ & Keine Nullstelle & unten & gestaucht\\ \hline 
$f_2$ & $S(0|-2)$ & $x=0$ & Keine Nullstelle & unten & gestreckt\\ \hline 
$f_3$ & $S(1|-2)$ & $x=1$ & Keine Nullstelle & unten & gestreckt\\ 
...
\vspace{1em} 
$f_1(x)=- 2 \left(x + 2\right)^{2} - 1$\\[1em] 
\end{minipage} 
\begin{minipage}{0.1\textwidth} 
 ~ \end{minipage} 
...
\begin{scope} 
\clip (-3,-3) rectangle (3,3); 
\draw[color=black] plot[smooth] function{-2*(x + 2)**2 - 1}; 
\end{scope} 
...
\begin{scope} 
\clip (-3,-3) rectangle (3,3); 
\draw[color=black] plot[smooth] function{-2*(x + 1)**2 + 2}; 
\end{scope} 
\end{tikzpicture}\end{minipage} 
\begin{minipage}{0.1\textwidth} 
 ~ \end{minipage} 
...
\vspace{1em} 
$f_1(x)=- 2 \left(x + 1\right)^{2} + 2$\\[1em] 
$\cancel{f_2(x)=- 2 \left(x - 1\right)^{2} + 1}$\\[1em] 
$\cancel{f_3(x)=3 \left(x - 2\right)^{2} + 1}$\\[1em] 
$\cancel{f_4(x)=- \left(x + 2\right)^{2} - 1}$\\[1em] 
\end{minipage} 
...
\item 
$f_3(x)=2 x^{2} - 8 x + 11$ \\ 
$f_3(x)=2 \left(x - 2\right)^{2} + 3$ \\ 

\item 
$f_4(x)=2 x^{2} + 12 x + 17$ \\ 
$f_4(x)=2 \left(x + 3\right)^{2} - 1$ \\ 

\item 
$f_5(x)=- 2 x^{2} + 8 x - 8$ \\ 
$f_5(x)=- 2 \left(x - 2\right)^{2}$ \\ 

\item 
$f_6(x)=3 x^{2} + 6 x + 2$ \\ 
$f_6(x)=3 \left(x + 1\right)^{2} - 1$ \\ 
