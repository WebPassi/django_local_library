...
\draw (1.5,-0.8) node[right] {$\scriptscriptstyle f_3$}; 
\end{scope} 
...
$f_2$ & $S(-1|-2)$ & $x=-1$ & $x_1\approx 0,\hspace{-2pt}41\quad x_2\approx-2,\hspace{-2pt}41$\\ \hline 
$f_3$ & $S(1|-1)$ & $x=1$ & $x_1=0\quad x_2=2$\\ 
...
\vspace{1em} 
$f_1(x)=\left(x + 2\right)^{2} - 1$\\[1em] 
$\cancel{f_2(x)=\left(x - 1\right)^{2} + 2}$\\[1em] 
$\cancel{f_3(x)=\left(x + 2\right)^{2} + 2}$\\[1em] 
...
\draw[color=black] plot[smooth] function{(x + 1)**2 - 1}; 
\draw (-0.5,-0.8) node[right] {$\scriptscriptstyle f_3$}; 
\draw[color=black] plot[smooth] function{(x - 1)**2 - 2}; 
\draw (1.5,-1.8) node[right] {$\scriptscriptstyle f_4$}; 
\draw[color=black] plot[smooth] function{(x - 2)**2 - 2}; 
\draw (2.5,-1.8) node[right] {$\scriptscriptstyle f_5$}; 
\draw[color=black] plot[smooth] function{(x + 2)**2 - 2}; 
\draw (-1.5,-1.8) node[right] {$\scriptscriptstyle f_6$}; 
\end{scope} 
\end{tikzpicture}\end{aufgabe} 
\begin{aufgabe} ~ \\ 
