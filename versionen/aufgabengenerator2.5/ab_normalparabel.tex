...
\begin{document} 
    \begin{flushleft}
\begin{aufgabe} ~ \\ 
Erstelle f\"ur die Funktion $f=x^{2} - 3$ eine Wertetabelle und zeichne den dazugeh\"origen Graphen im Bereich von $x=-3$ bis $x=3$ in ein Koordinatensystem.\end{aufgabe} 
\begin{aufgabe} ~ \\ 
...
\draw (-0.5,-0.8) node[right] {$\scriptscriptstyle f_1$}; 
\draw[color=black] plot[smooth] function{(x - 1)**2 + 1}; 
...
\draw (-0.5,0.2) node[right] {$\scriptscriptstyle f_4$}; 
\draw[color=black] plot[smooth] function{(x + 1)**2 - 1}; 
\draw (-0.5,-0.8) node[right] {$\scriptscriptstyle f_5$}; 
\end{scope} 
...
$f_1$ & $S(-1|-1)$ & $x=-1$ & $x_1=-2\quad x_2=0$\\ \hline 
$f_2$ & $S(1|1)$ & $x=1$ & Keine Nullstelle\\ \hline 
$f_3$ & $S(0|2)$ & $x=0$ & Keine Nullstelle\\ \hline 
$f_4$ & $S(-1|0)$ & $x=-1$ & $x=-1$\\ \hline 
$f_5$ & $S(-1|-1)$ & $x=-1$ & $x_1=-2\quad x_2=0$\\ 
...
\draw[color=black] plot[smooth] function{(x + 2)**2}; 
\draw (-1.5,0.2) node[right] {$\scriptscriptstyle f_4$}; 
\draw[color=black] plot[smooth] function{(x - 2)**2 - 1}; 
\draw (2.5,-0.8) node[right] {$\scriptscriptstyle f_5$}; 
\draw[color=black] plot[smooth] function{x**2}; 
\draw (0.5,0.2) node[right] {$\scriptscriptstyle f_6$}; 
\end{scope} 
