...
$f_2$ & $S(1|2)$ & $x=1$ & Keine Nullstelle\\ \hline 
$f_3$ & $S(-2|2)$ & $x=-2$ & Keine Nullstelle\\ 
...
\draw (-1.5,-0.8) node[right] {$\scriptscriptstyle f_4$}; 
\draw[color=black] plot[smooth] function{(x - 1)**2}; 
\draw (1.5,0.2) node[right] {$\scriptscriptstyle f_5$}; 
\draw[color=black] plot[smooth] function{(x + 1)**2}; 
