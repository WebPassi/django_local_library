...
\begin{scope} 
\clip (-3,-3) rectangle (3,3); 
\draw[color=black] plot[smooth] function{(x + 2)**2/3 - 1}; 
\draw (-1.5,-0.8) node[right] {$\scriptscriptstyle f_1$}; 
\draw[color=black] plot[smooth] function{-3*(x + 1)**2/4}; 
\draw (-0.5,0.2) node[right] {$\scriptscriptstyle f_2$}; 
\draw[color=black] plot[smooth] function{x**2/4 - 2}; 
...
$f_1$ & $S(-2|-1)$ & $x=-2$ & $x_1\approx -3,\hspace{-1pt}73\quad x_2\approx-0,\hspace{-1pt}27$ & oben & gestaucht\\ \hline 
$f_2$ & $S(-1|0)$ & $x=-1$ & $x=-1$ & unten & gestaucht\\ \hline 
$f_3$ & $S(0|-2)$ & $x=0$ & $x_1\approx -2,\hspace{-1pt}83\quad x_2\approx2,\hspace{-1pt}83$ & oben & gestaucht\\ 
...
\vspace{1em} 
$f_1(x)=\frac{1}{2} \left(x + 1\right)^{2}$\\[1em] 
\end{minipage} 
\begin{minipage}{0.1\textwidth} 
 ~ \end{minipage} 
...
\begin{scope} 
\clip (-3,-3) rectangle (3,3); 
\draw[color=black] plot[smooth] function{3*(x + 1)**2/2 - 2}; 
\draw (-3,-3) -- (3,3); 
\end{scope} 
...
\begin{scope} 
\clip (-3,-3) rectangle (3,3); 
\draw[color=black] plot[smooth] function{-x**2/4 + 1}; 
\end{scope} 
\end{tikzpicture}\end{minipage} 
\begin{minipage}{0.1\textwidth} 
 ~ \end{minipage} 
...
\vspace{1em} 
$\cancel{f_1(x)=- 2 \left(x + 2\right)^{2} - 2}$\\[1em] 
$\cancel{f_2(x)=\left(x + 2\right)^{2} + 1}$\\[1em] 
$\cancel{f_3(x)=\left(x + 1\right)^{2} - 1}$\\[1em] 
$f_4(x)=- \frac{x^{2}}{4} + 1$\\[1em] 
\end{minipage} 
...
\item 
$f_1(x)=3 x^{2} + 6 x + 5$ \\ 
$f_1(x)=3 \left(x + 1\right)^{2} + 2$ \\ 

\item 
$f_2(x)=3 x^{2} - 18 x + 29$ \\ 
$f_2(x)=3 \left(x - 3\right)^{2} + 2$ \\ 
...
\item 
$f_5(x)=2 x^{2} + 12 x + 18$ \\ 
$f_5(x)=2 \left(x + 3\right)^{2}$ \\ 

\item 
$f_6(x)=2 x^{2} + 8 x + 8$ \\ 
$f_6(x)=2 \left(x + 2\right)^{2}$ \\ 
