...
\draw (3.5,1.2) node[right] {$\scriptscriptstyle f_1$}; 
\draw[color=black] plot[smooth] function{(x + 2)**2}; 
\draw (-1.5,0.2) node[right] {$\scriptscriptstyle f_2$}; 
...
$f_1$ & $S(3|1)$ & $x=3$ & Keine Nullstelle\\ \hline 
$f_2$ & $S(-2|0)$ & $x=-2$ & $x=-2$\\ \hline 
...
\vspace{1em} 
$\cancel{f_1(x)=\left(x + 1\right)^{2} - 1}$\\[1em] 
$f_2(x)=\left(x - 2\right)^{2} - 1$\\[1em] 
$\cancel{f_3(x)=\left(x - 1\right)^{2} + 1}$\\[1em] 
$\cancel{f_4(x)=\left(x - 1\right)^{2} + 1}$\\[1em] 
\end{minipage} 
