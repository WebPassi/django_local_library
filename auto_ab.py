...
def ta_ue():
    ...
    for i in range(2):
        ...
        a.append(par1 + "-" + par2 + "*" + var + "-" + par3 + "*" + var)
        
        a.append("-" + par2 + "*" + var + "+" + par1 + "-" + par3 + "*" + var)

        a.append(par1 + "-" + par2 + "*" + var + "-" + par3)
    ...
    par1=str(zufallZ(2,10))
    par2=str(zufallZ(2,10))
    par3=str(zufallZ(2,10))
...
def ab_linglg():
    ...
    ### Loesungen
    loes=list(range(anzahl_aufgaben*anzahl_menge))
    strloes=""
    index=0
