...
def ableitungPotenz():
    ...
    fp.write(latex("f(x)=",mode='inline'))
    fp.write(latex(expr,mode='inline'))
    fp.write('\\\\')
    fp.write('\n')

    ft.write(latex("f(x)=",mode='inline'))
...
def ableitungFaktor():
    a = random.randint(-100,100)/10.0
    n = random.randint(0,10)
    expr = a*x**n
    lsg = expr.diff(x)
    # Don't write the solution in pupil's file
    fp.write(latex("f(x)=",mode='inline'))
    fp.write(latex(expr,mode='inline').replace('.',','))
    fp.write('\\\\')
    fp.write('\n')

    ft.write(latex("f(x)=",mode='inline'))
    ft.write(latex(expr,mode='inline').replace('.',','))
    ft.write('\\\\')
    ft.write('\n')
    ft.write(latex("f'(x)=",mode='inline'))
    ft.write(latex(lsg,mode='inline').replace('.',','))
    ft.write('\n')




def ableitungSummeInt():
    a = random.randint(-10,10)
...
def ableitungSumme():
    ...
    ft.write('\\\\')
    ft.write('\n')
    ft.write(latex("f'(x)=",mode='inline').replace('.',','))
    ft.write(latex(lsg,mode='inline'))
    ft.write('\n')



def ableitungNegativ():
    a = random.randint(-20,20)
    n = random.randint(-20,0)
    expr = a*x**n
    lsg = expr.diff(x)
    # Don't write the solution in pupil's file
    fp.write(latex("f(x)=",mode='inline'))
