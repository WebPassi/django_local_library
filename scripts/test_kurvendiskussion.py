...
def kurvendiskussion(funktion,cas="o"):
    ...
    ta="Untersuchen Sie das Verhalten von $f(x)$ im Unendlichen und das Symmetrieverhalten von $f(x)$."
    aufg.append(ta)
    ...
    ta="Zeichnen Sie den Graphen von $f(x)$. (10 LE $\\widehat{=}$ 1 cm)"
    aufg.append(ta)
...
for i in range(1): 
    ...
    a=7
    b=-5
    kurvendiskussion(a*x**4+b*x**3,"o") 
    fp.write('\n')
    ft.write('\n')
